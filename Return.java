...
public class Return {
 ...
 Book1 ib = new Book1() ;
  static Scanner asb = new Scanner(System.in) ;
 
	
	public static void lautana() {
	...
	if (in == 1157 || in == 1158 || in == 1250 || in == 1110 || in == 1643 )
	{
		...
		if (in == 1157)
		{
			...
			System.out.println("Return successful! you have returned book: "+ iin );
			
			LibMan.amt[0]=LibMan.amt[0]+1;
			System.out.println("Available Books "+LibMan.amt[0]);
		...
		else if (in == 1158)
		{
			...
			System.out.println("Available Books "+LibMan.amt[1]);
		}
		...
		else if (in ==1250 )
		{
			...
			System.out.println("Available Books "+LibMan.amt[2]);
		}
		...
		else if ( in == 1110) 
		{
			...
			System.out.println("Available Books "+LibMan.amt[3]);
		}
		...
		else if (in == 1643) 
		{
			...
			System.out.println("Available Books "+LibMan.amt[4]);		}
